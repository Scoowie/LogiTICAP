...
export default async function PortalDashboard() {
  ...
  return (
    <div className="mx-auto max-w-6xl">
      ...
      <div className="mt-7">
        {booking ? (
          <Card className="border-t-4 border-t-[#d6a72d]">
            ...
            <div className="mt-6 rounded-md bg-[#f4f7fa] p-4 text-sm">
              <h3 className="font-bold">Preparation instructions</h3>
              <p className="muted mt-1 whitespace-pre-wrap">
      ...
      <div className="mt-6 grid gap-5 md:grid-cols-2">
        <Card>
          <h2 className="font-bold text-[#183f63]">Deadlines</h2>
        ...
        <Card>
          <h2 className="font-bold text-[#183f63]">Announcements</h2>
          <p className="muted mt-2 text-sm">
